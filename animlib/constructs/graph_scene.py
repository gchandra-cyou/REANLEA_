...
from animlib.animation import*
from animlib.mobject.functions import*
from manim import*
from animlib.const import*
from animlib.animation.creation import*
...
class GraphScene(Scene):
    CONFIG={
        ...
        "default_input_color": REANLEA_YELLOW,
        "default_riemann_start_color": REANLEA_BLUE,
        "default_riemann_end_color": REANLEA_GREEN,
        "area_opacity": 0.8,
        "num_rects": 50,
    }
    ...
    def setup_axes(self, animate=False):
        ...
        if self.x_axis_label:
            x_label = Text(self.x_axis_label)
            x_label.next_to(
        ...
        if self.y_axis_label:
            y_label = Text(self.y_axis_label)
            y_label.next_to(
